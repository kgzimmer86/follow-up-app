...
begin
  ...
  pre_spatial_filtered as (
    ...
    where
      ...
      and (
        v_spreadsheet_jesus is null
        or b.jesus_interest = v_spreadsheet_jesus
        or (
          v_spreadsheet_jesus = 'unanswered'
          and nullif(btrim(b.jesus_interest), '') is null
        )
      )

      and (
        v_spreadsheet_community is null
        or b.community_interest = v_spreadsheet_community
        or (
          v_spreadsheet_community = 'unanswered'
          and nullif(btrim(b.community_interest), '') is null
        )
      )

      and (
        v_spreadsheet_interview is null
        or b.interview_interest = v_spreadsheet_interview
        or (
          v_spreadsheet_interview = 'unanswered'
