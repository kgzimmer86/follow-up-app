-- Spreadsheet-only column filters. Run this complete file in Supabase SQL Editor before deploying.
-- Filters are applied before pagination so later spreadsheet pages remain accurate.
begin;

DROP FUNCTION IF EXISTS public.get_follow_up_contact_results_v2(text, text, text, integer, integer, text, text, text, text, text, text, text, text, text, text, text, text, boolean, text);
...
REVOKE ALL ON FUNCTION public.get_follow_up_contact_results_v2(text, text, text, integer, integer, text, text, text, text, text, text, text, text, text, text, text, text, boolean, text, text, text, text, text, text, text, text, text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_follow_up_contact_results_v2(text, text, text, integer, integer, text, text, text, text, text, text, text, text, text, text, text, text, boolean, text, text, text, text, text, text, text, text, text) TO authenticated;
